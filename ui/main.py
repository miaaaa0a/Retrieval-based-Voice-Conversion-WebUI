...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.indexRateVal = QtWidgets.QLineEdit(parent=self.groupBox)
        self.indexRateVal.setGeometry(QtCore.QRect(250, 140, 51, 20))
        self.indexRateVal.setReadOnly(True)
        self.indexRateVal.setObjectName("indexRateVal")
